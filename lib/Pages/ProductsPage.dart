          ...
          children: [
            ...
            ListTile(
                onTap: () {
                  ...
                  provider.signOut().then((value) => Navigator.of(context)
                      .pushAndRemoveUntil(
                                  ...
                                  child: Column(
                                    children: [
                                      ...
                                      MaterialButton(
                                        ...
                                        onPressed: () {
                                          final provider = Provider.of<Auth>(
                                              context,
                                              listen: false);
                                          ...
                                          documentReference.set(add).then(
                                              (value) => Scaffold.of(context)
                                                  .showSnackBar(SnackBar(
                                                      content: Text(
                                                          '${data.docs[index]['Title']} is added to cart...'))));
                                        },
                                    ...
                                    child: Padding(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                              'Rs.${data.docs[index]['Price'].toString()}',
                                              style: TextStyle(
                                                  color: Colors.black,
                                                  fontSize: 17,
                                                  fontWeight: FontWeight.bold,
...
Color MyColor() {
  return Color.fromARGB(255, math.Random().nextInt(256),
